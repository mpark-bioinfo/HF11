...
Lipid_Info <- data.frame(paste(NewLipidData$Class, paste(NewLipidData$Carbon_Chain, ":", NewLipidData$Double_Bond, sep="")))
...
new_out <- paste(args[2],tissue_name[[1]][1],"_WT_BKS.txt", sep="")
...
new_out <- paste(args[2],tissue_name[[1]][1],"_db_BKS.txt", sep="")
...
new_out <- paste(args[2],tissue_name[[1]][1],"_WT_BL6.txt", sep="")
...
new_out <- paste(args[2],tissue_name[[1]][1],"_db_BL6.txt", sep="")
...
new_out <- paste(args[2],tissue_name[[1]][1],"_WT_BTBR.txt", sep="")
...
new_out <- paste(args[2],tissue_name[[1]][1],"_db_BTBR.txt", sep="")
